export { s as setup } from './render-35b59193.js';
 ...
 */
declare function composeStory<TArgs extends Args = Args>(story: StoryAnnotationsOrFn<VueRenderer, TArgs>, componentAnnotations: Meta<TArgs | any>, projectAnnotations?: ProjectAnnotations<VueRenderer>, exportsName?: string): _storybook_types.PartialArgsStoryFn<VueRenderer, Partial<TArgs>> & {
    args: Partial<TArgs>;
    id: string;
    play?: ((context?: Partial<_storybook_types.PlayFunctionContext<VueRenderer, Partial<Partial<TArgs>>>> | undefined) => void | Promise<void>) | undefined;
    load: () => Promise<void>;
    storyName: string;
    parameters: _storybook_types.Parameters;
    argTypes: _storybook_types.StrictArgTypes<Partial<TArgs>>;
} & (new (...args: any[]) => any);
/**
